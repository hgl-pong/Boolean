...
namespace MathLib
{
    ...
    int tri_tri_overlap_test_3d(HReal p1[3], HReal q1[3], HReal r1[3],
    ...
    int coplanar_tri_tri3d(HReal  p1[3], HReal  q1[3], HReal  r1[3],
        HReal  p2[3], HReal  q2[3], HReal  r2[3],
        HReal  N1[3], HReal  N2[3]);


    // Two dimensional Triangle-Triangle Overlap Test
    int tri_tri_overlap_test_2d(HReal p1[2], HReal q1[2], HReal r1[2],
        HReal p2[2], HReal q2[2], HReal r2[2]);
...
*/
    ...
    int coplanar_tri_tri3d(HReal p1[3], HReal q1[3], HReal r1[3],
        HReal p2[3], HReal q2[3], HReal r2[3],
        HReal normal_1[3], HReal normal_2[3]) {

        HReal P1[2], Q1[2], R1[2];
        HReal P2[2], Q2[2], R2[2];
...
#define INTERSECTION_TEST_EDGE(P1, Q1, R1, P2, Q2, R2) { \
  ...
  if (ORIENT_2D(P1,R1,R2) >= 0.0f) return 1;  \
    ...
    int ccw_tri_tri_intersection_2d(HReal p1[2], HReal q1[2], HReal r1[2],
        HReal p2[2], HReal q2[2], HReal r2[2]) {
